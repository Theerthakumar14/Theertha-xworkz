class Alpha
{
	...
	public static void bAlphabet()
	{
		...
		for(int i =0; i<n; i++)
		{
			for(int j=0; j<n; j++)
			{
				if(i==0 && j!=n-1 || j==0 || i==n-1 && j!=n-1 || i==mid || j==n-1 && i!=0 && i!=(n-1) )
				{
					System.out.print(i+""+j+" ");
				} 
				else
	...
	public static void gAlphabet()
	{
		...
		for(int i =0; i<n; i++)
		{
			for(int j=0; j<n; j++)
			{
				if(i==0 && mid>=j || j==0 || i==(n-1) && mid>=j ||mid==j && mid<=i || mid==i && mid<j || j==(n-1) && mid<=i)
				{
					System.out.print(i+""+j+" ");
				} 
				else
	...
	public static void oAlphabet()
	{
		...
		for(int i =0; i<n; i++)
		{
			for(int j=0; j<n; j++)
			{
				if(j==0 && i!=0 && i!=(n-1) || i==0 &&j!=0 && j!=n-1|| j==n-1 &&i!=0 && i!=n-1 || i==n-1 && j!=n-1 &&j!=0 )
				{
					System.out.print("*  ");
				} 
				else
	...
	public static void qAlphabet()
	{
		...
		for(int i =0; i<n; i++)
		{
			for(int j=0; j<n; j++)
			{
				if(j==0 && i!=n-1&& mid>=i || i==0 &&j!=0 && mid>=j || mid==j && mid>=i || mid==i && mid>=j ||i==j &&mid<=i)
				{
					System.out.print(i+""+j+" ");
				} 
				else
	...
	public static void sAlphabet()
	{
		...
		for(int i =0; i<n; i++)
		{
			for(int j=0; j<n; j++)
			{
				if(j==0 && i!=0 && mid>=i || i==0 &&j!=0 || mid==i || j==n-1&& mid<i&& i!=n-1 || i==n-1 && j!=n-1)
				{
					System.out.print(i+""+j+" ");
				} 
				else
